...
public class TrackingService {
    ...
    public Optional<TrackingInfo> getTrackingInfo(long id) {
    	return trackingInfoRepository.findById(id);
    }
    public Optional<TrackingInfo> getTrackingInfoByParcelId(long id){
    	return trackingInfoRepository.findByParcelId(id);
    }
